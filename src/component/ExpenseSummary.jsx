...
import { BiTrendingDown, BiTrendingUp, BiWallet } from 'react-icons/bi'
            ...
            <div className='bg-white rounded-lg shadow-md p-6 hover:shadow-lg'>
                <div className=' flex items-center space-x-4'>
                    <div className='bg-expense-light p-3 rounded-full'>
                        <BiWallet size={24} className='text-expense' />
                    </div>
                    <div>
            ...
            <div className='bg-white rounded-lg shadow-md p-6 hover:shadow-lg'>
                <div className=' flex items-center space-x-4'>
                    <div className='bg-red-100 p-3 rounded-full'>
                        <BiTrendingUp size={24} className='text-red-500' />
                    </div>
                    <div>
                        <h3 className='text-sm font-medium text-gray-500'>Highest Category </h3>
                        <p className='text-2xl font-bold text-expense-dark'>{highestCategory.name !== "none" ? (
                            <>
             ...
             <div className='bg-white rounded-lg shadow-md p-6 hover:shadow-lg'>
                <div className=' flex items-center space-x-4'>
                    <div className='bg-green-100 p-3 rounded-full'>
                        <BiTrendingDown size={24} className='text-green-500' />
                    </div>
                    <div>
